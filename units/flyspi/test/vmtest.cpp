...
for(uint l=0;l<loops;l++){
	cout<<dec<<"Memory testloop "<<l<<" with size "<<testsize<<"."<<endl;
...
TEST(VMTest, IDontKnowWhatItDoes)
{
//select loggin level
Logger::instance("vmodule.test.VMTest",Logger::DEBUG2,"");
...
status.setStatus(0);
ASSERT_EQ(status.getStatus()&0xff,0x10);
